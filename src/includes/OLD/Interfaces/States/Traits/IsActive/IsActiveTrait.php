...
/**
 * Trait for working with the IsActiveInterface interface.
 *
 * @since   1.0.0
 * @version 1.0.0
...
trait IsActiveTrait {
	...
	protected function maybe_check_is_active_traits(): bool {
		if ( false !== array_search( IsActiveExtensionTrait::class, Misc::class_uses_deep_list( $this ), true ) ) {
	...
	protected function maybe_check_is_active_local(): bool {
		if ( in_array( IsActiveLocalTrait::class, Misc::class_uses_deep_list( $this ), true ) && method_exists( $this, 'is_active_local' ) ) {
